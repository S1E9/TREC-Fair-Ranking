...
# python3 trec-fair-ranking-evaluator.py --groundtruth_file TREC-Fair-Ranking-training-sample.json --query_sequence_file dummy_sequence.csv --group_annotations_file h_idx_2_cls.csv --group_definition "h_index_2"
